...
#define CUSTOM_MACHINE_NAME "JGAurora A5S MKS SBASE"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1600, 790 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  242    // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  0.02 //0.025 (mm) Step size while manually probing Z axis.
