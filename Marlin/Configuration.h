...
#define STRING_CONFIG_H_AUTHOR "(rebel1, JGAurora A5S config)" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  106.44
  #define DEFAULT_BED_KI   21.27
  #define DEFAULT_BED_KD 355.16
