...
#define STRING_CONFIG_H_AUTHOR "(rebel1, JGAurora A5S config)" // Who made the changes.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.0530f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1226f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0941f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1752f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//JGAurora A5S 24V Heatbed tunes at 75 degreesC 
  #define DEFAULT_bedKp 106.44
  #define DEFAULT_bedKi 21.27
  #define DEFAULT_bedKd 355.16 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 300, 30, 60 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 1500, 50, 5000 }
